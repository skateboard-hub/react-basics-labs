...
function App() {
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Go shopping", description:"Buy some meat and fruit", deadline: "The day after tomorrow"},
      { id: 5, title: "finall year project", description:"A game", deadline:"School year end"}
    ]
  });
  return (
